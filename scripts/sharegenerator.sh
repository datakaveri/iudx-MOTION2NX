...
# /home/srishti04/IUDX/iudx-MOTION2NX/build_debwithrelinfo_gcc/config_files/file_config_model
# /home/srishti04/IUDX/iudx-MOTION2NX/build_debwithrelinfo_gcc/Dataprovider/weights_provider
if [ ! -d "$debug_0" ];
then
