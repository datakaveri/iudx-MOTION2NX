...
$build_path/bin/server0 --WB_file file_config_model0 --image_file $input_config  --my_port $port0_inference --party_1 $cs1_ip,$port1_inference --helper_node $helpernode_ip,$helpernode_port --current-path $build_path --fractional-bits $fractional_bits > $build_path/server0/debug_files/server0.txt &
pid1=$!
...
# $build_path/bin/server0 --WB_file file_config_model0 --image_file $input_config  --my_port $port0_inference --party_1 $cs1_ip,$port1_inference --helper_node $helpernode_ip,$helpernode_port --current-path $build_path --fractional-bits $fractional_bits > $build_path/server0/debug_files/server0_layer{$layer_id}.txt &
# pid1=$!
