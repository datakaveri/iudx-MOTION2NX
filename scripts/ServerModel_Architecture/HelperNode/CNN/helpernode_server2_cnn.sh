...
#    $build_path/bin/3PC_MatMul_Relu_2 --party 0,$cs0_host,$cs0_port_inference --party 1,$cs1_host,$cs1_port_inference --helper_node $helpernode_host,$helpernode_port_inference --current-path ${BASE_DIR}/build_debwithrelinfo_gcc > $debug_2/helpernode_layer${layer_id}.txt &
#    pid2=$!
#    wait $pid2
#    check_exit_statuses $?
#    echo "Helper node layer $layer_id is done"
...
# ####################################### Matrix multiplication layer 1 ###########################################################################
  ...
  $build_path/bin/3PC_CNN_NN_2 --layers $number_of_layers --layer-types ${new_layer_types[@]} --party 0,$cs0_host,$cs0_port_inference --party 1,$cs1_host,$cs1_port_inference --helper_node $helpernode_host,$helpernode_port_inference --current-path $build_path &
  pid1=$!
  wait $pid1
  check_exit_statuses $?
