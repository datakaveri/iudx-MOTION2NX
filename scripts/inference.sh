...
$build_path/bin/tensor_gt_relu --my-id 0 --party 0,192.168.1.141,7002 --party 1,192.168.0.113,7000 --arithmetic-protocol beavy --boolean-protocol yao --fractional-bits $fractional_bits --filepath file_config_input0 --current-path $build_path > $build_path/server0/debug_files/tensor_gt_relu0_layer1.txt &
pid1=$!
...
$build_path/bin/argmax --my-id 0 --party 0,192.168.1.141,7000 --party 1,192.168.0.113,7001 --arithmetic-protocol beavy --boolean-protocol beavy --repetitions 1 --config-filename file_config_input0 --config-input X$i --current-path $build_path  > $build_path/server0/debug_files/argmax0_layer2.txt &
pid1=$!
