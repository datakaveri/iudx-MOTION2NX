...
$build_path/bin/Weights_Share_Receiver_remote --my-id 1 --port $cs1_port_data_receiver --file-names $model_config --current-path $build_path >> $debug_1/Weights_Share_Receiver.txt &
pid2=$!
