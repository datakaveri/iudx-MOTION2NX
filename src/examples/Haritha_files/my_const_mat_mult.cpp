...
int main(int argc, char* argv[]) {
  ...
  std::string p1 =  "/home/iudx/motion2nx-LATEST/iudx-MOTION2NX/data/ImageProvider/X.csv";
/*******************************************/
//*** using DECODE on vector data ********//
/*******************************************/
// std :: cout << "*****In my_const_mat_mult ***** \n";
// std::vector<uint64_t> output_share_temp;
// output_share_temp.push_back(8192*2);
// output_share_temp.push_back(4096/2);
// //auto output_share_temp
// std::vector<float> output_share_decoded;
// output_share_decoded.push_back(0);
// output_share_decoded.push_back(0);
// std::size_t fractional_bits = 13;
// std::transform(std::begin(output_share_temp), std::end(output_share_temp), std::begin(output_share_decoded),
//                  [fractional_bits](auto j) { return fp::decode<std::uint64_t, float>(j, 13); });
//  for (auto i = 0; i < output_share_temp.size(); i++) {
