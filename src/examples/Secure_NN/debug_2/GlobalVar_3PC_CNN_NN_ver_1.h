#ifndef GLOBALVAR_CNN_NN_VER_1_H
#define GLOBALVAR_CNN_NN_VER_1_H
...
bool OT_flag = false;
bool conv_flag_0 = false;
bool reluABYAck_Flag = false;
bool matrix_add_mul_flag_0 = false;
...
enum MessageType {SC, SC_P, SC_D, SC_PC, XArithToABY, YArithToABY, HelperNodeSync, X_PrivateShares, Y_PrivateShares, OT, ComputeMSBReady, MSB_Odd, MSB_P, MSB_L_LSB, MSB_R, MSB_PC, ReluReady, Relu_XArithToABY, Relu_YArithToABY, Relu_X_PrivateShares, Relu_Y_PrivateShares, Relu_OT, OtherPartySync, ArithToABY, ConvolutionOpMessage, MatrixMulAddOpMessage, ReluSync, reluABYAck};
