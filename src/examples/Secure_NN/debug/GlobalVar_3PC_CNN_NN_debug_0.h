#ifndef GLOBALVAR_CNN_NN_DEBUG_0_H
#define GLOBALVAR_CNN_NN_DEBUG_0_H
...
// Global variables for convolution
...
// Vectors for storing intermediate shares of convolution operation
...
enum MessageType {SC, SC_P, SC_D, SC_PC, XArithToABY, YArithToABY, HelperNodeSync, X_PrivateShares, Y_PrivateShares, OT, ComputeMSBReady, MSB_Odd, MSB_P, MSB_L_LSB, MSB_R, MSB_PC, ReluReady, Relu_XArithToABY, Relu_YArithToABY, Relu_X_PrivateShares, Relu_Y_PrivateShares, Relu_OT, OtherPartySync, ArithToABY, ConvolutionOpMessage, ReluSync, reluABYAck};
