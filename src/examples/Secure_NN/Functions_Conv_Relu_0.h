#ifndef FUNCTIONS_CONV_RELU_0_H
#define FUNCTIONS_CONV_RELU_0_H
...
#include "GlobalVar_Conv_Relu_0.h"
...
int ReLU(std::vector<std::uint64_t>& a_L_0, std::vector<std::uint64_t>& a_Relu_0, std::size_t rows, std::size_t cols) {
  ...
  std::cout << "Relu_x_temp_vec.size(): " << Relu_x_temp_vec.size() << std::endl;
