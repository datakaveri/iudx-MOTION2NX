#include "Functions_3PC_CNN_NN_1.h"
      ...
      case ConvolutionOpMessage:
        ...
        message.erase(message.begin());
          ...
          if (party_id == helpernode_id) {
            ...
            if (Z.size() == k - offset) {
              operationsConvolutionOperation();
        ...
        case ReluSync:
          ...
          {
            std::cerr<<"Received the message " << ReluSync <<  " from unknown party id "<<party_id<<std::endl;
            return;
          }
        break;
...
int main(int argc, char* argv[]) {
  ...
  for (int layer_id = 1; layer_id <= numberOfLayers; layer_id++) {
    ...
    // Add layer id and type parameter here
