...
#include "Functions_MatMul_Relu_1.h"
...
int main(int argc, char* argv[]) {
  ...
  std::cout << "Dimensions: " << reluRows << " " << reluCols << std::endl;
  std::cout << A_MatMul_Public_Shares[0] << " " << A_MatMul_Public_Shares[1] << std::endl;
  std::cout << A_MatMul_Private_Shares[0] <<  " " << A_MatMul_Private_Shares[1] << std::endl;
  ...
  std::cout << A_MatMul_Public_Shares.size() << std::endl;
  std::cout << A_MatMul_Private_Shares.size() << std::endl;
  std::cout << A_L.size() << std::endl;
  ...
  ReluOutputFile << rowsABYShares << " " << colsABYShares << std::endl;
  std::cerr << "Output dimensions: " << rowsABYShares << " " << colsABYShares << std::endl;
